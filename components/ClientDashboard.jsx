...
const PRODUCT_LINKS = [
  ...
  {
    label: "Contact",
    href: "mailto:hadmin@mymeedai.org",
    description: "Phone: +60 11-3757-6465 • Email: admin@mymeedai.org",
    icon: FaPhoneAlt,
    accent: "amber",
  },
  {
...
const SERVICE_ROLES = [
  {
    title: "AI Developer",
    blurb: "Agents, copilots, and automation that actually ship.",
  },
  {
    title: "AI Researcher",
    blurb: "Precision experiments, eval harnesses, distilled insights.",
  },
  {
    title: "Data Scientist",
    blurb: "Pipelines, models, and dashboards wired into decisions.",
  },
  {
    title: "Systems Analyst",
    blurb: "Map ops, surface bottlenecks, deploy fixes that compound.",
  },
  {
    title: "AI Model Builder",
    blurb: "Custom fine-tunes, validation, and deploy-ready playbooks.",
  },
  {
    title: "Focus Systems Architect",
    blurb: "Rituals, tooling, and accountability for elite execution.",
  },
];
  ...
  const ventureSpotlight = [
    ...
    },
    {
      ...
      actions: [
        ...
        { href: "mailto:nafisaslam70@gmail.com?subject=Deep%20Calendar%20APK%20Request", label: "Request mobile APK", external: true, variant: "ghost" },
      ],
    },
    {
  ...
  return (
    <div className="min-h-screen">
      <nav className="pointer-events-none fixed left-2 top-24 z-40 hidden lg:block">
        <div className="pointer-events-auto relative w-[116px] overflow-hidden rounded-[1.2rem] border border-indigo-200/60 bg-white/80 p-2 shadow-lg backdrop-blur dark:border-white/10 dark:bg-white/[0.06]">
          <div className="absolute -left-14 top-6 h-24 w-24 rounded-full bg-indigo-400/25 blur-3xl dark:bg-indigo-500/25" />
          <div className="absolute -right-14 bottom-0 h-22 w-22 rounded-full bg-purple-400/25 blur-[70px] dark:bg-purple-600/20" />
          <div className="absolute left-[16px] top-4 bottom-10 w-px bg-gradient-to-b from-indigo-300/70 via-indigo-500/50 to-pink-400/45" />
                ...
                <li key={section.id} className="relative pl-4">
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute left-0 right-2 top-1/2 h-10 -translate-y-1/2 rounded-2xl bg-gradient-to-r from-indigo-500/95 via-purple-500/85 to-pink-500/85 shadow-[0_14px_32px_-18px_rgba(79,70,229,0.85)]"
                    />
                  )}
                  <button
                    type="button"
                    onClick={() => handleNavClick(section.id)}
                    className={`group relative flex w-full items-center gap-2 rounded-2xl px-1.5 py-1.5 text-[9px] font-semibold uppercase tracking-[0.18em] transition duration-300 ${
                      isActive
                        ? "text-white"
                  ...
                  >
                    <span
                      className={`relative flex h-8 w-8 items-center justify-center rounded-2xl border text-xs transition duration-300 ${
                        isActive
                    ...
                    <span
                      className={`overflow-hidden whitespace-nowrap text-[9px] transition-all duration-300 ${
                        isActive
                          ? "max-w-[95px] opacity-95"
                          : "max-w-0 opacity-0 group-hover:max-w-[75px] group-hover:opacity-90"
                      }`}
                    >
                      {section.label}
                    </span>
      ...
      <aside className="pointer-events-none fixed right-2 top-24 z-40 hidden xl:block">
        <div className="pointer-events-auto relative w-[110px] overflow-hidden rounded-[1.15rem] border border-indigo-200/60 bg-white/80 p-1.5 shadow-md backdrop-blur dark:border-white/10 dark:bg-white/[0.06]">
          <div className="absolute -left-12 top-6 h-22 w-22 rounded-full bg-indigo-400/25 blur-2xl dark:bg-indigo-500/25" />
          <div className="absolute -right-12 bottom-0 h-20 w-20 rounded-full bg-purple-400/25 blur-[60px] dark:bg-purple-600/20" />
          <div className="absolute left-[16px] top-3 bottom-12 w-px bg-gradient-to-b from-indigo-300/70 via-indigo-500/45 to-pink-400/45" />
          <div className="relative space-y-2">
            <div>
              <div className="text-xs uppercase tracking-[0.32em] text-indigo-500 dark:text-indigo-300">
                Quick Access
              </div>
            ...
            <ul className="relative flex flex-col gap-1">
              {PRODUCT_LINKS.map((item) => {
                ...
                return (
                  <li key={item.href} className="relative pl-4">
                    <a
                      href={item.href}
                      target="_blank"
                      rel="noreferrer"
                      className={`group relative flex items-center gap-3 rounded-2xl px-2 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600 transition duration-300 dark:text-slate-200 ${accent?.hover ?? "hover:text-indigo-600 dark:hover:text-indigo-300"}`}
                    >
                      <span
                        className={`relative flex h-6 w-6 items-center justify-center rounded-2xl border bg-white/85 text-indigo-600 shadow-sm transition group-hover:bg-white dark:border-white/10 dark:bg-white/[0.08] ${accent?.ring ?? "border-indigo-200/70 hover:border-indigo-300"}`}
                      >
                        <Icon className={accent?.icon ?? "text-indigo-600 dark:text-indigo-300"} />
                        <span className="absolute inset-0 rounded-2xl bg-gradient-to-b from-white/40 via-transparent to-transparent opacity-0 transition group-hover:opacity-100 dark:from-white/10" />
                      </span>
                      <span className="overflow-hidden whitespace-nowrap text-left text-[8px] transition-all duration-300 group-hover:max-w-[88px] group-hover:opacity-90">
                        <span className={`block text-[9px] font-semibold ${accent?.icon ?? "text-indigo-600 dark:text-indigo-300"}`}>
                          {item.label}
                        </span>
                        {item.description && (
                      ...
                      <span
                        className={`absolute right-0 top-1/2 h-1.5 w-1.5 -translate-y-1/2 scale-50 rounded-full bg-gradient-to-r opacity-0 shadow-sm transition group-hover:scale-90 group-hover:opacity-60 ${accent ? accent.glow : "from-indigo-400 via-purple-400 to-pink-400"}`}
                      />
                    </a>
                  </li>
                );
      ...
      >
        <div className="space-y-6">
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Operator-as-a-Service</h2>
              <p className="text-sm text-gray-600 dark:text-gray-300">Embedded execution partner for AI-heavy teams, edtech labs, and ambitious operators.</p>
            </div>
            <Link
              href="/hire-me"
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {SERVICE_ROLES.map((service, idx) => (
              ...
              >
                <span className="text-xs uppercase tracking-[0.24em] text-indigo-500 dark:text-indigo-300">
                  Service
                </span>
