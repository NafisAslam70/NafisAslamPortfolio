  ...
  return (
    <article className="max-w-5xl mx-auto px-4 py-10 space-y-10 md:space-y-16">
      ...
      <motion.section
        ...
        className="rounded-3xl border bg-[rgba(var(--fg-rgb),0.045)] p-7 md:p-9"
      ...
      >
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <div className="space-y-3 md:w-2/3">
            <span
              ...
              style={{ borderColor: "rgba(var(--fg-rgb), 0.15)", background: "rgba(var(--fg-rgb), 0.04)" }}
            >
              Spotlight
            </span>
        ...
        <div
          ...
          style={{ borderColor: "rgba(var(--fg-rgb), 0.18)", background: "rgba(var(--fg-rgb), 0.05)" }}
        >
      ...
      <motion.section
        ...
        variants={sectionVariants}
        className="rounded-3xl border bg-[rgba(var(--fg-rgb),0.04)] p-6 md:p-8"
        style={{ borderColor: "rgb(var(--border))" }}
      >
        <div className="flex flex-col gap-4 md:flex-row md:items-start">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border text-sm font-semibold uppercase tracking-wide" style={{ borderColor: "rgba(var(--fg-rgb), 0.18)" }}>
            FYI
          </div>
              ...
              <div>
                {card.featured && (
                  <span
                    ...
                    style={{
                      borderColor: "rgba(var(--fg-rgb), 0.15)",
                      background: "rgba(var(--fg-rgb), 0.04)",
                    }}
                  >
                    Spotlight
