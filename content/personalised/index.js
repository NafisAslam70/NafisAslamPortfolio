const SHANKAR_MESSAGE = {
  ...
  headline:
    "Hello Dr Shankar, I’m actively looking for an AI/Web developer or Research Assistant role in your group.\n\nI’ve just completed the B.CompSc (Intelligent Computing) at USM (Oct 2025) and I’m wrapping up the MIT MicroMasters in Statistics & Data Science (edX) — only the final exam remains. I’d love to contribute to your Machine Learning and AI projects and help NAV6/CRC (Cybersecurity Research Centre, Universiti Sains Malaysia) move faster. These are things I could offer to you right now (customised to your current setup).",
  intro: null,
  offers: [
    {
